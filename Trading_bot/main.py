...
def get_last_data(symbol, interval,filename):
    candles = client.get_historical_klines(symbol = symbol, interval=interval)
...
df =  get_last_data(ASSET, Client.KLINE_INTERVAL_3MINUTE, '/workspaces/Individual-HW/Trading_bot/KLINE.txt')
